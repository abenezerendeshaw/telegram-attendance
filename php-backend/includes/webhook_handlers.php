<?php
// ── Shared Telegram webhook command handlers ───────────────────────────────
// Used by both the per-company webhook (webhook/index.php) and the shared
// default Specific Ethiopian bot webhook (webhook/shared.php).
